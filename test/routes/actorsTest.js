...
describe("🎭 Rotas de Atores (/actors)", () => {
    ...
    it("Deve criar um novo ator e definir actorId para os próximos testes", (done) => {
      request.execute(uri)
        ...
        .end((err, res) => {
          ...
          // Como o POST não retorna o ator, buscamos na lista
          request.execute(uri)
            .get("/actors")
            .end((err2, res2) => {
    ...
    it("Deve retornar status 200 e uma lista de atores contendo o ator criado", (done) => {
      request.execute(uri)
        ...
        .end((err, res) => {
          ...
          expect(actorId, "actorId deveria estar definido antes deste teste").to.exist;
  ...
  describe("DELETE /actors/:id - Remover Ator", () => {
    it("Deve retornar status 204 (No Content) ao remover o ator", (done) => {
      expect(actorId, "actorId não definido antes do DELETE /actors/:id").to.exist;
